...
var app = {
    ...
    test: function() {
        ...
        firebase.init('BenjaminDemo', function(success) {
            alert("init success: " + success);
            ...
            firebase.setPersistenceEnabled(true, function(success) {
                ...
                firebase.writeData(testObj, function(success) {
                    alert("writeData success" + testObj.toString());
                    firebase.readData(testObj, function(success) {
                        console.log(success)
                    });
                });
            });
